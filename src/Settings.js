...
document.getElementById('charcoalDiv').addEventListener('click', () => changeTheme('charcoal'));
...
function changeTheme(color) {
    ...
    switch (color) {
        ...
        case 'green':
            ...
            document.documentElement.style.setProperty('--main-bg-color', '#28332A');
        ...
        case 'red':
            ...
            break;
        case 'charcoal':
            document.documentElement.style.setProperty('--main-bg-color', '#1A1C1E');
            document.documentElement.style.setProperty('--second-bg-color', 'rgb(39, 51, 58)');
            document.documentElement.style.setProperty('--darker-bg-color', 'rgb(43, 59, 69)');
            break;
        default:
